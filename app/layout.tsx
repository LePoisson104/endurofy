...
export const metadata: Metadata = {
  title: {
    template: "%s | Endurofy",
    default: "Endurofy - Your Complete Fitness Companion",
  },
  description:
    "An all-in-one fitness platform combining workout tracking, weight and nutrition logging to help you perform at your best.",
