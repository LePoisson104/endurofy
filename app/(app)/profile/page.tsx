    ...
    <div className="container mx-auto p-[1rem] max-w-7xl">
      ...
      {userInfo ? (
        <div className="flex flex-col gap-6">
          ...
          {/* Edit profile card */}
          {userInfo?.data?.profile_status === "complete" ? (
            <>
              {isEditing ? (
                <Card>
                  <CardHeader>
                  ...
                  <div className="grid gap-6 md:grid-cols-2">
                        ...
                        <div>
                          ...
                          <p className="text-lg font-medium">
                            {userInfo?.data?.birth_date
                              ? format(
                                  new Date(userInfo?.data?.birth_date),
                                  "PPP"
                                )
                              : ""}
                          </p>
                    ...
                    <Card className="md:col-span-2">
                      <CardHeader>
                        ...
                        <CardDescription>
                          Your energy expenditure based on your metrics and
                          activity level
                        </CardDescription>
                      </CardHeader>
                      <Separator />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div className="space-y-4">
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground mt-1">
                                The number of calories your body needs to
                                maintain basic functions at rest
                              </p>
                            </div>
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <p className="text-3xl font-bold mt-1">
                                {calculateTDEE(userInfo?.data?.BMR)}{" "}
                                calories/day
                              </p>
                              <p className="text-sm text-muted-foreground mt-1">
                                The total calories you burn each day based on
